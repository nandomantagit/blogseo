...
class PostController extends Controller
{
    ...
    {
        $post = Posts::paginate(10); //membuat pagination sambung ke index.blade.php di bawah </tabble>
    ...
    {
        //migrate table softdelete/deleted_at and use SoftDeletes di model Posts
