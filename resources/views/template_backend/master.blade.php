...
<body>
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <!-- memangil file sidebar di dalam folder template_backend, dengan include fungsi dari blade template -->
      ...
      <div class="main-content">
        <section class="section">
          ...
          <!-- memanggil file yang ada di dalam section 'content' dengan menggunakan yield blade template  -->
          @yield('content')
      ...
      <!-- memangil file footer di dalam folder template_backend, dengan include fungsi dari bladetemplate -->
